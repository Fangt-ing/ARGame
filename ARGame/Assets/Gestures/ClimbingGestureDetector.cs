...
/// </summary>
public class ClimbingGestureDetector : IDisposable
{
    ...
    public ClimbingGestureDetector(KinectSensor kinectSensor)
    {
        // load the gesture from the gesture database
        var databasePath = Application.streamingAssetsPath + "" + "/TrunkRight.gbd";
