...
public class TPoseKinectManagerFirstScene : MonoBehaviour
{
    ...
    private List<TPoseGestureDetectorFirstScene> gestureDetectorList = null;
    ...
    void Start()
    {
        ...
        else
        {
            ...
            this.gestureDetectorList = new List<TPoseGestureDetectorFirstScene>();
            for (int bodyIndex = 0; bodyIndex < this.bodyCount; bodyIndex++)
            {
                this.gestureDetectorList.Add(new TPoseGestureDetectorFirstScene(this.kinectSensor));
            }
