...
public class TPoseKinectManagerSecondScene : MonoBehaviour
{
    ...
    private List<TPoseGestureDetectorSecondScene> gestureDetectorList = null;
    ...
    void Start()
    {
        ...
        else
        {
            ...
            this.gestureDetectorList = new List<TPoseGestureDetectorSecondScene>();
            for (int bodyIndex = 0; bodyIndex < this.bodyCount; bodyIndex++)
            {
                this.gestureDetectorList.Add(new TPoseGestureDetectorSecondScene(this.kinectSensor));
            }
